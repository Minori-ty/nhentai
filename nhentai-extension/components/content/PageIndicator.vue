...
<template>
    <div
        class="pointer-events-none fixed top-32 right-4 z-50 rounded-lg border border-gray-700 bg-gray-800/90 px-3 py-2 text-base text-gray-300 shadow-lg backdrop-blur select-none"
    >
