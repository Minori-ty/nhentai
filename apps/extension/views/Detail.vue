...
const isDownloaded = computed(() => gallery.value && downloadedIds.value.has(gallery.value.id))
const currentProgress = computed(() => (gallery.value && downloadProgress.value.get(gallery.value.id)) || 0)
